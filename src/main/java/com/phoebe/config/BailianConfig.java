...
public class BailianConfig {
    ...
    /**
     * Default category ID for data center file uploads.
     * This is required for uploading files to Bailian data center.
     * Create a category in Bailian console (数据中心 -> 分类管理) and get the ID.
     */
